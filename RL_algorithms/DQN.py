...
from utils_functions.ReplayMemory import ReplayMemory, PrioritizedReplayBuffer
...
class RDDQN(DDQN):
    ...
    def __init__(self, env: CustomEnv, options=None) -> None:
        ...
        self.memory = ReplayMemory(self.obs_dim, 
                                   1, # 1 because it's a discrete action algorithm
                                   1_000_000, 
                                   device)
